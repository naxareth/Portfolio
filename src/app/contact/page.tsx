        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a 
              ...
              className="w-full sm:w-auto px-8 py-4 bg-foreground text-background rounded-full text-sm font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
            >
            ...
            <a 
              ...
              className="w-full sm:w-auto px-8 py-4 border border-border rounded-full text-sm font-medium hover:bg-surface transition-colors flex items-center justify-center gap-2"
            >
