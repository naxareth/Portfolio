    ...
    <footer className="px-4 md:px-8 pb-8 mt-24">
      <div className="relative max-w-6xl mx-auto bg-surface/80 backdrop-blur-md border border-border shadow-lg rounded-3xl p-8 md:p-12 overflow-hidden [text-shadow:none]">
        ...
        <div>
          ...
          <ul className="space-y-2 text-muted text-sm flex flex-col">
            <li>
              <a href="https://github.com/naxareth" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors flex items-center">
            ...
            <li>
              <a href="https://www.linkedin.com/in/ace-philip-soriano-denulan-2b55603a3" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors flex items-center">
            ...
            <li>
              <a href="mailto:acephilipdenulan12@gmail.com" className="hover:text-foreground transition-colors flex items-center">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                Email
              </a>
            </li>
            <li>
              <a href="tel:+639494123473" className="hover:text-foreground transition-colors flex items-center">
